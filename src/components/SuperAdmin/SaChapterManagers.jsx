...
const SaChapterManagers = () => {
  ...
  const getAllChapterManagers = async () => {
    toast.dismiss();
    try {
      setisLoading(true);
      let response = await axios.get(
        `${import.meta.env.VITE_REACT_APP_BASE_URL}/user/getAllChapterManagers`
      );
...
export default SaChapterManagers;
